...
public class HttpRequestData {
    ...
    private String remoteComputerRequest;
    private String remoteComputerAddress;
    private String httpMethodRequest;
    ...
    /**
     * Sets the value of remoteComputerRequest.
     * @param remoteComputerRequest The value to assign remoteComputerRequest.
     */
    public void setRemoteComputerRequest(String remoteComputerRequest) {
        this.remoteComputerRequest = remoteComputerRequest;
    }
    ...
    /**
     * Sets the value of httpMethodRequest.
     * @param httpMethodRequest The value to assign httpMethodRequest.
     */
    public void setHttpMethodRequest(String httpMethodRequest) {
